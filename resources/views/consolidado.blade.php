...
<html lang="pt-BR">
  <head>
	...
	<script src="{{ asset('js/api/consolidado.js') }}"></script>
			  ...
			  <div class="container-fluid">
						...
						<div class="input-group col-md-8">
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
									<button class="dropdown-item" type="button" id="pFor" onclick="pFormulario()">Nº Formulário  </button>
									<button class="dropdown-item" type="button" id="pCert" onclick="pCertificado()">Nº Certificado </button>
									<button class="dropdown-item" type="button" id="pCiclo" onclick="pCiclo()">Ciclo </button>
								</div>
								</div>
							</div>
							<input type="text" class="form-control" id="pesquisaFormulario" onchange="pesquisaFormulario()">
							<input type="text" class="form-control" id="pesquisaCertificado" onchange="pesquisaCertificado()" style="display: none">
							<input type="text" class="form-control" id="pesquisaCiclo" onchange="pesquisaCiclo()" style="display: none">
						</div>
						<div class="col-md-1">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
				  <ul class="nav navbar-nav ml-auto">
					<li >
						<a class="btn btn-dark" href="cadconsolidado/0"><i class="fa fa-plus" aria-hidden="true"></i> Novo</a>
					</li>
				  </ul>
				</div>
			  </div>
  ...
  <div class="card-body">
    <div class="card-text">
		<ul class="nav nav-tabs" role="tablist">
			...
			<a href="#"><li role="presentation" class="nav-link" id="finalizados" onclick="abas(2)">Finalizados</li></a>
		</ul>
				...
				<table class="table table-hover">
					<thead style="background-color: #555353; color: #E5E5E5">
					  <tr>
						...
						<th scope="col" style="width: 75px; text-align: center">Finaliza</th>
					  </tr>
					</thead>
					<tbody id="tb-cc">
