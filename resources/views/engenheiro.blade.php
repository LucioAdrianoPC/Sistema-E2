...
<html lang="pt-BR">
  <head>
	...
	<script src="{{ asset('js/api/engenheiro.js') }}"></script>
...
<body onload="popEngenheirosAtivos()">
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
				  <ul class="nav navbar-nav ml-auto">
					<li >
						<a class="btn btn-dark" href="cadengenheiro/0"><i class="fa fa-plus" aria-hidden="true"></i> Novo</a>
					</li>
				  </ul>
				</div>
			  </div>
