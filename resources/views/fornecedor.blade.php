...
<html lang="pt-BR">
  <head>
	...
	<script src="{{ asset('js/api/fornecedor.js') }}"></script>
...
<body onload="popFornecedoresAtivos()">
			  ...
			  <div class="container-fluid">
						...
						<div class="input-group col-md-8">
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
									...
									<button class="dropdown-item" type="button" id="pCNPJ" onclick="pCNPJ()">CNPJ </button>
								</div>
								</div>
							</div>
							<input type="text" class="form-control" id="pesquisaNome" onkeyup="pesquisaNome()">
							<input type="text" class="form-control" id="pesquisaCNPJ" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" onkeyup="pesquisaCNPJ()" style="display: none">
						</div>
						<div class="col-md-1">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
				  <ul class="nav navbar-nav ml-auto">
					<li >
						<a class="btn btn-dark" href="cadfor/0"><i class="fa fa-plus" aria-hidden="true"></i> Novo</a>
					</li>
				  </ul>
				</div>
			  </div>
  ...
  <div class="card-body">
    <div class="card-text">
		<ul class="nav nav-tabs" role="tablist">
			<a href="#" ><li role="presentation" class="nav-link active" id="ativos" onclick="abas(1)">Ativos</li></a>
			<a href="#"><li role="presentation" class="nav-link" id="inativos" onclick="abas(2)">Inativos</li></a>
		</ul>
				...
				<table class="table table-hover">
					<thead style="background-color: #555353; color: #E5E5E5">
					  <tr>
						...
						<th scope="col" style="width: 50px;">Situação</th>
					  </tr>
					</thead>
					<tbody id="tb-ea">
