...
<html lang="pt-BR">
  <head>
	...
	<script src="{{ asset('js/api/empresa.js') }}"></script>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
				  <ul class="nav navbar-nav ml-auto">
					<li >
						<a class="btn btn-dark" href="cadempresa/0"><i class="fa fa-plus" aria-hidden="true"></i> Novo</a>
					</li>
				  </ul>
				</div>
			  </div>
