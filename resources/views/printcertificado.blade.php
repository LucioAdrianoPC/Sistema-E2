...
<head>
    ...
    <script src="{{ asset('js/api/printcertificado.js') }}"></script>
...
<body class="A4" style="margin-left: 20%; margin-right: 20%;" >
	...
	<div class="row" id="imprimir" style="align-content: center; text-align: center; margin-top: 10px;">
		...
		<div class="col-2">
			<button type="button" class="btn btn-outline-warning" onclick="window.location='../certificado'">Fechar</button>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<table>
					...
					<tr>
						<td class="info res" id="localTratamento"></td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<table>
					...
					<tr>
						<td class="info res">- ONLY THE WOODEN CREATES (PALLETS) HAVE BEEN TRATED</td>
					</tr>
					<tr>
